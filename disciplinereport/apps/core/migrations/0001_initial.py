    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_source', models.FileField(storage=disciplinereport.s3utils._MediaS3BotoStorage(bucket=b'disciplinereport-dev', custom_domain=b'disciplinereport-dev.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),
                ('file_minified', models.FileField(storage=disciplinereport.s3utils._MediaS3BotoStorage(bucket=b'disciplinereport-dev', custom_domain=b'disciplinereport-dev.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.compounds.core.models.title_file_name, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compiler', models.CharField(default=b'css', max_length=255, verbose_name=b'Compiler / Preprocessor', choices=[(b'css', b'CSS (None)'), (b'scss', b'SASS')])),
