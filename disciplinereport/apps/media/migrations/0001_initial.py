    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file_modified_date', models.DateTimeField(null=True, verbose_name='File Modified Date', blank=True)),
                ...
                ('image', models.ImageField(help_text=b'To ensure a precise color replication in image variants, make sure an sRGB color profile has been assigned to each image.', storage=disciplinereport.s3utils._MediaS3BotoStorage(bucket=b'disciplinereport-dev', custom_domain=b'disciplinereport-dev.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.image_file_name, blank=True)),
                ...
                ('wide_crop', imagekit_cropper.fields.ImageCropField(null=True, properties={b'format_field': b'get_format', b'width': 1200, b'resize_method': b'fill', b'height': 600, b'source': b'image', b'upscale': True, b'crop_field': b'wide_crop'}, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(related_name='media_imagefolder_created_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('image', models.ForeignKey(related_name='media_imagefolder_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Featured image', null=True)),
                ('modified_by', models.ForeignKey(related_name='media_imagefolder_modified_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.ImageFolder', null=True)),
                ('published_by', models.ForeignKey(related_name='media_imagefolder_published_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('social_share_image', models.ForeignKey(related_name='media_imagefolder_social_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Standards for the social share image vary, but an image at least 300x200px should work well.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('use_png', models.BooleanField(default=False, help_text=b'Render image as png instead of jpg when possible', verbose_name=b'Use .PNG (instead of .JPG)')),
                ('image', models.ImageField(help_text=b'To ensure a precise color replication in image variants, make sure an sRGB color profile has been assigned to each image.', storage=disciplinereport.s3utils._MediaS3BotoStorage(bucket=b'disciplinereport-dev', custom_domain=b'disciplinereport-dev.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.image_file_name, blank=True)),
                ('file', models.FileField(storage=disciplinereport.s3utils._MediaS3BotoStorage(bucket=b'disciplinereport-dev', custom_domain=b'disciplinereport-dev.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.media_file_name, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField(help_text=b'', null=True, verbose_name='content', blank=True)),
                ('synopsis', models.TextField(help_text=b'', null=True, verbose_name='synopsis', blank=True)),
                ('created_by', models.ForeignKey(related_name='media_mediafolder_created_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('image', models.ForeignKey(related_name='media_mediafolder_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Featured image', null=True)),
                ('modified_by', models.ForeignKey(related_name='media_mediafolder_modified_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.MediaFolder', null=True)),
                ('published_by', models.ForeignKey(related_name='media_mediafolder_published_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('social_share_image', models.ForeignKey(related_name='media_mediafolder_social_images', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='media.Image', help_text=b'Standards for the social share image vary, but an image at least 300x200px should work well.', null=True)),
                ('template', models.ForeignKey(blank=True, to='core.Template', help_text=b'Template for view', null=True)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt', models.CharField(help_text=b'Alt text (very important for SEO)', max_length=255, verbose_name='Alt Text', blank=True)),
                ('use_png', models.BooleanField(default=False, help_text=b'Render image as png instead of jpg when possible', verbose_name=b'Use .PNG (instead of .JPG)')),
                ('image', models.ImageField(help_text=b'To ensure a precise color replication in image variants, make sure an sRGB color profile has been assigned to each image.', storage=disciplinereport.s3utils._SecureMediaS3BotoStorage(bucket=b'disciplinereport-dev-secure', custom_domain=b'disciplinereport-dev-secure.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.image_file_name, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_size', models.CharField(max_length=255, null=True, verbose_name='Display Size', blank=True)),
                ('file_modified_date', models.DateTimeField(null=True, verbose_name='File Modified Date', blank=True)),
                ('file', models.FileField(storage=disciplinereport.s3utils._SecureMediaS3BotoStorage(bucket=b'disciplinereport-dev-secure', custom_domain=b'disciplinereport-dev-secure.s3.amazonaws.com', location=b'media'), null=True, upload_to=carbon.atoms.models.media.media_file_name, blank=True)),
        ...
        migrations.AddField(
            model_name='media',
            name='folder',
            field=models.ForeignKey(related_name='media_media_folder', blank=True, to='media.MediaFolder', null=True),
        ),
        migrations.AddField(
            model_name='media',
            name='modified_by',
            field=models.ForeignKey(related_name='media_media_modified_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='media',
            name='tags',
        ...
        migrations.AddField(
            model_name='image',
            name='folder',
            field=models.ForeignKey(related_name='media_image_folder', blank=True, to='media.ImageFolder', null=True),
        ),
        migrations.AddField(
            model_name='image',
            name='modified_by',
            field=models.ForeignKey(related_name='media_image_modified_by', on_delete=django.db.models.deletion.SET_NULL, blank=True, to=settings.AUTH_USER_MODEL, null=True),
        ),
        migrations.AddField(
            model_name='image',
            name='tags',
